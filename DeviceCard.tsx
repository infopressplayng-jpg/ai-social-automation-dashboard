...
import { SOCIAL_APP_ICONS, STATUS_COLORS } from '../constants';
...
const DeviceCard: React.FC<DeviceCardProps> = ({ device, onAssignTask, onReboot, isMasterBusy }) => {
  ...
  return (
    <>
      <div className="bg-gray-800/50 rounded-lg shadow-lg p-4 flex flex-col justify-between transition-all duration-300 hover:shadow-indigo-500/20 hover:scale-[1.02]">
        <div>
